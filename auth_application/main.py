...
db_path = "auth_application/users.db"  

# Fonction pour hacher le nom d'utilisateur
...
#Fonction pour insérer le nom d'utilisateur et le mot de passe dans la base de donnée
...
#Fonction pour vérifier le mot de passe saisie existe parmis ceux de la base de donnée
...
#Fonction qui représente la page d'accueil
def accueil():
    global main_windows
    main_windows = Tk()
...
#Fonction qui représente la page d'inscription
...
#Fonction qui représente la page de connexion
def connexion_page():
    global value_username, username, value_password, password
...
#Fonction qui représente la page principal après la connexion d'un utilisateur
def user_main_page():
    global main_page
...
#Appel de la fonction acceuil | démarrage du script
accueil()